...
import { logo, menu, search, thirdweb, donablock } from '../assets';
...
const navbar = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between-mb-[35px] gap-6">
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4 mx-auto">
        <CustomButton
          btnType="button"
        ...
        <Link to="/profile">
          ...
          justify-center items-center cursor-pointer mx-auto">
            <img src={donablock} alt="user" className="w-[60%] h-[60%] object-contain" />
          </div>
        </Link>
      </div>
