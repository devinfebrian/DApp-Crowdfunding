...
import { donablock, thirdweb } from '../assets';
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img src={state.image} alt="campaign" className="w-full
          h-[410px] object-cover rounded-x1" />
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div>
            ...
            flex-wrap gap-[14px]">
              ...
              cursor-pointer">
                <img src={donablock} alt="user" className="w-[60%] h-[60%]
                object-contain" />
              </div>
              <div>
                <h4 className="font-epilogue font-semibold text-
                [14px] text-white breal-all">{state.owner}</h4>
          ...
          <div>
            ...
            <div className="mt-[20px]">
              <p className="font-epilogue
                font-normal text-[12px] text-[#808191] leading-[26px]
          ...
          bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              rounded-[10px]">
                ...
                font-normal leading-[22px] text-[#808191]">Support the project for no reward, just because is speaks to you.</p>
              </div>
